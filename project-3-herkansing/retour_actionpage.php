...
try {
    ...
    $stmt = $connection->prepare("INSERT INTO retour (naam_achternaam, telefoonnummer, order_nummer, reden_voor_retour)
    VALUES (:naam_achternaam, :telefoonnummer, :ordernummer, :reden) ");
